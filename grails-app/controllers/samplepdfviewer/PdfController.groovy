    ...
    def delete = {
        ...
        if (pdfInstance) {
            try {
                ...
                flash.message = "${message(code: 'default.deleted.message', args: [message(code: 'pdf.label', default: 'Pdf'), params.uniqueId])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${message(code: 'default.not.deleted.message', args: [message(code: 'pdf.label', default: 'Pdf'), params.uniqueId])}"
                redirect(action: "show", id: params.uniqueId)
            }
        }
        else {
            flash.message = "${message(code: 'default.not.found.message', args: [message(code: 'pdf.label', default: 'Pdf'), params.uniqueId])}"
